...
import com.google.idea.blaze.base.query.GeneratedTarget;
import com.google.idea.blaze.base.query.MacroTargetProvider;
...
public class MacroLineMarkerProvider implements LineMarkerProvider {
  ...
  @Override
  @SuppressWarnings("rawtypes")
  public void collectSlowLineMarkers(List<PsiElement> elements, Collection<? super LineMarkerInfo<?>> result) {
    if (!enabled.getValue()) {
      return;
    }
  ...
  private static String getTooltip(List<GeneratedTarget> genTargets) {
    String targetRows =
        genTargets.stream()
            .sorted(com.google.idea.sdkcompat.query.MacroLineMarkerProvider::compare)
            .map(t -> tooltipText(t))
            .collect(joining("<br>"));
